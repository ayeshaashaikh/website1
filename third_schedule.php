...
if (isset($_POST['update_schedule'])) {
    ...
    $query = "UPDATE schedule_third SET time = '{$time}', Mon = '{$mon}', Tue = '{$tue}', Wed = '{$wed}', Thu = '{$thu}', Fri = '{$fri}', Sat = '{$sat}' WHERE id = {$schedule_id}";
...
$query = "SELECT * FROM schedule_third";
